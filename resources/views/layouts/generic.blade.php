                ...
                <ul class="nav-menu">
                    ...
                    <li class="menu-has-children"><a href="">Trainings</a>
                        <ul>
                            ...
                            <li><a href="{{ url('trainings/create') }}">Create Training</a></li>
                        </ul>
                    </li>
                    @guest
        ...
        <div class="row d-flex justify-content-center">
            <div class="menu-content col-lg-9">
                <div class="title text-center">
                    <h1 class="mb-10 text-white">Laravel Training</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 social-widget">
                <div class="single-footer-widget">
                    ...
                    <div class="footer-social d-flex align-items-center">
                        <a href="http://facebook.com/xxx" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="http://twitter.com/xxx" target="_blank"><i class="fa fa-twitter"></i></a>
                        <a href="http://instagram.com/xxx" target="_blank"><i class="fa fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
